...
function AddBillingAddress({ navigation }) {
        ...
        >
          {({
            ...
            <View>
              ...
              <Text className="text-white">Address line 1</Text>
              <TextInput
              ...
              <Text className="text-white">Address line 2</Text>
              ...
              <Text className="text-white">Postal Code</Text>
              <TextInput
                onChangeText={handleChange("password")}
                onBlur={handleBlur("password")}
                value={values.password}
